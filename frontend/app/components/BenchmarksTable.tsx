...
const COLUMNS: Column[] = [
  ...
  },
  {
    ...
    cell: (row) => { const gpu = realGpu(row.gpuModel); const secondary = gpu ? row.cpuModel : row.os; return <><strong title={gpu ?? row.cpuModel}>{gpu ?? row.cpuModel}</strong><small title={secondary}>{secondary}</small></>; },
  },
  {
