...
mv -f "$ROOT_DIR/dist/encodingdb-client-macos" "$BUILD_DIR/encodingdb-client-macos" 2>/dev/null || true
mv -f "$ROOT_DIR/dist/encodingdb-client-macos"* "$BUILD_DIR/" 2>/dev/null || true
